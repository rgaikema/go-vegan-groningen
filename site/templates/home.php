		...
		<section class="top">
			...
			<nav class="mobile-nav" id="js-mobile-nav">
				<ul class="mobile-nav-list">
					<li class="mobile-nav-list-item" id="js-mobile-nav-1">Info</li>
					<li class="mobile-nav-list-item" id="js-mobile-nav-2">Inspiratie</li>
					<li class="mobile-nav-list-item" id="js-mobile-nav-3">Contact</li>
				</ul>
			</nav>
		</section>
		...
		<section class="map-holder section">
			...
			<div class="info-box" id="info-box">
				<div class="info-toggle-holder"><span><h1>Vegan hotspots in Groningen</h1></span>
		  		...
		  		<i class="info-box-info" id="js-info-box-info">Click on one of the markers to view location information</i>
